        ...
        <div id='overlay' onClick={watchClick} className={styles.overlay}>
            <div className={styles.window}>
                ...
                <div className={styles.window_wrapper}>
                    ...
                    <textarea value={modal.inputComplain} onChange={e=>inputComplain(e.target.value)} className={styles.window_input} placeholder='Сообщение'/>
                    <Button click={submitComplain} width='197px' height='52px' text='Отправить'/>
                </div>
            </div>
        </div>

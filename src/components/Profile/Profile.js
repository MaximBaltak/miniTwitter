        ...
        <main className={styles.content}>
            ...
            <div className={styles.content_profile}>
                <div className={styles.content_profile_flex}>
                    <img className={styles.content_profile_flex_avatar} src={user.avatar} alt="avatar"
                         title='Александр Попов'/>
                    <p className={styles.content_profile_flex_name}>{user.name}</p>
                    <div className={[styles.content_profile_flex_information, showInfo ? styles.content_profile_flex_activeInformation : ''].join(' ')}>

        ...
        <main className={styles.content}>
            ...
            <div className={styles.content_profile}>
                <div className={styles.content_profile_flex}>
                    <img onClick={() => setfullscreen(prev => !prev)} className={styles.content_profile_flex_avatar}
            ...
            {animation((props, fullscreen) =>
               fullscreen? <animated.div style={props} onClick={() => setfullscreen(prev => !prev)} className={styles.content_fullscreen}>
